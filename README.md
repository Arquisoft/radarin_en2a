![CI for radarin](https://github.com/arquisoft/radarin_en2a/workflows/CI%20for%20radarin/badge.svg)
...
Link to the deployed application: [radarin](https://radarinen2awebapp.herokuapp.com/). Note that sometimes **it can take a while to load** because Heroku in the free plan, takes the containers to sleep when they are not used for some time and taking them up takes time.
...
To run the mobileapp you need to set up the [Android development environment](./mobileapp/docs/android-development.md). Then:
```
cd mobileapp
npm install
npm run android
